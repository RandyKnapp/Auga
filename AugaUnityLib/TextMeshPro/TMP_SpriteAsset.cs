...
namespace TMProX
{
    ...
    public class TMP_SpriteAsset : TMP_Asset
    {
        ...
        public List<TMP_SpriteCharacter> spriteCharacterTable
        {
            ...
            set { m_SpriteCharacterTable = value; }
        }
        [SerializeField]
        ...
        public Dictionary<uint, TMP_SpriteCharacter> spriteCharacterLookupTable
        {
            ...
            set { m_SpriteCharacterLookup = value; }
        }
        public Dictionary<uint, TMP_SpriteCharacter> m_SpriteCharacterLookup;

        public List<TMP_SpriteGlyph> spriteGlyphTable
        {
            get { return m_SpriteGlyphTable; }
            set { m_SpriteGlyphTable = value; }
        }
        [SerializeField]
        private List<TMP_SpriteGlyph> m_SpriteGlyphTable = new List<TMP_SpriteGlyph>();

        public Dictionary<uint, TMP_SpriteGlyph> m_SpriteGlyphLookup;
        ...
        public bool m_IsSpriteAssetLookupTablesDirty = false;
        ...
        /// <summary>
        /// public method used to upgrade sprite asset.
        /// </summary>
