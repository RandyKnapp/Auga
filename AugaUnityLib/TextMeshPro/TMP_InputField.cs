...
#pragma warning restore 169
        ...
        /// Getters are setters are protected
        /// </summary>

        protected int caretPositionpublic { get { return m_CaretPosition + compositionLength; } set { m_CaretPosition = value; ClampCaretPos(ref m_CaretPosition); } }
        protected int stringPositionpublic { get { return m_StringPosition + compositionLength; } set { m_StringPosition = value; ClampStringPos(ref m_StringPosition); } }

        protected int caretSelectPositionpublic { get { return m_CaretSelectPosition + compositionLength; } set { m_CaretSelectPosition = value; ClampCaretPos(ref m_CaretSelectPosition); } }
        protected int stringSelectPositionpublic { get { return m_StringSelectPosition + compositionLength; } set { m_StringSelectPosition = value; ClampStringPos(ref m_StringSelectPosition); } }

        private bool hasSelection { get { return stringPositionpublic != stringSelectPositionpublic; } }
        ...
        {
            get { return caretSelectPositionpublic; }
        ...
        public int selectionFocusPosition
        {
            get
            {
                return caretSelectPositionpublic;
            }
            set
            {
                if (compositionLength != 0)
                ...
                caretSelectPositionpublic = value;
                m_IsStringPositionDirty = true;
            }
        }
        ...
        {
            get { return stringSelectPositionpublic; }
        ...
        public int selectionStringFocusPosition
        {
            get
            {
                return stringSelectPositionpublic;
            }
            set
            {
                if (compositionLength != 0)
                ...
                stringSelectPositionpublic = value;
                m_IsCaretPositionDirty = true;
            }
        }
        ...
        private void ON_TEXT_CHANGED(UnityEngine.Object obj)
        {
            ...
            if (isThisObject)
            {
                ...
                {
                    caretPositionpublic = GetCaretPositionFromStringIndex(stringPositionpublic);
                    caretSelectPositionpublic = GetCaretPositionFromStringIndex(stringSelectPositionpublic);

                    #if TMP_DEBUG_MODE
                    Debug.Log("Caret Position: " + caretPositionpublic + " Selection Position: " + caretSelectPositionpublic + "  String Position: " + stringPositionpublic + " String Select Position: " + stringSelectPositionpublic);
                    #endif
                }
        ...
        {
            m_isSelectAll = true;
            stringPositionpublic = text.Length;
            stringSelectPositionpublic = 0;
        }
        ...
        public void MoveTextEnd(bool shift)
        {
            if (m_isRichTextEditingAllowed)
            {
                ...
                if (shift)
                {
                    stringSelectPositionpublic = position;
                }
                else
                {
                    stringPositionpublic = position;
                    stringSelectPositionpublic = stringPositionpublic;
                }
            }
            else
            {
                ...
                if (shift)
                {
                    caretSelectPositionpublic = position;
                    stringSelectPositionpublic = GetStringIndexFromCaretPosition(position);
                }
                else
                {
                    caretPositionpublic = caretSelectPositionpublic = position;
                    stringSelectPositionpublic = stringPositionpublic = GetStringIndexFromCaretPosition(position);
                }
            }
        ...
        public void MoveToEndOfLine(bool shift, bool ctrl)
        {
            ...
            int currentLine = m_TextComponent.textInfo.characterInfo[caretPositionpublic].lineNumber;
            ...
            if (shift)
            {
                ...
                caretSelectPositionpublic = characterIndex;
            }
            else
            {
                stringPositionpublic = position;
                ...
                caretSelectPositionpublic = caretPositionpublic = characterIndex;
            }
        ...
        void UpdateStringPositionFromKeyboard()
        {
            ...
            if (stringPositionpublic != selectionStart)
            {
                stringPositionChanged = true;
                stringPositionpublic = selectionStart;

                caretPositionpublic = GetCaretPositionFromStringIndex(stringPositionpublic);
            }

            if (stringSelectPositionpublic != selectionEnd)
            {
                stringSelectPositionpublic = selectionEnd;
                stringPositionChanged = true;
        ...
        protected virtual void LateUpdate()
        {
            ...
            //{
            //    int length = stringPositionpublic < stringSelectPositionpublic ? stringSelectPositionpublic - stringPositionpublic : stringPositionpublic - stringSelectPositionpublic;
            //    m_SoftKeyboard.selection = new RangeInt(stringPositionpublic < stringSelectPositionpublic ? stringPositionpublic : stringSelectPositionpublic, length);
            //}
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            if (m_isRichTextEditingAllowed)
            {
                ...
                {
                    stringSelectPositionpublic = m_TextComponent.textInfo.characterInfo[insertionIndex].index;
                }
                else if (insertionSide == CaretPosition.Right)
                {
                    stringSelectPositionpublic = m_TextComponent.textInfo.characterInfo[insertionIndex].index + m_TextComponent.textInfo.characterInfo[insertionIndex].stringLength;
                }
            }
            else
            {
                if (insertionSide == CaretPosition.Left)
                {
                    stringSelectPositionpublic = insertionIndex == 0
            ...
            if (hadFocusBefore || !m_OnFocusSelectAll)
            {
                ...
                else
                {
                    if (m_isRichTextEditingAllowed)
                    {
                        if (insertionSide == CaretPosition.Left)
                        {
                            stringPositionpublic = stringSelectPositionpublic = m_TextComponent.textInfo.characterInfo[insertionIndex].index;
                        }
                        else if (insertionSide == CaretPosition.Right)
                        {
                            stringPositionpublic = stringSelectPositionpublic = m_TextComponent.textInfo.characterInfo[insertionIndex].index + m_TextComponent.textInfo.characterInfo[insertionIndex].stringLength;
                        }
                    }
                    else
                    {
                        if (insertionSide == CaretPosition.Left)
                        {
                            stringPositionpublic = stringSelectPositionpublic = insertionIndex == 0
                                ? m_TextComponent.textInfo.characterInfo[0].index
                                : m_TextComponent.textInfo.characterInfo[insertionIndex - 1].index + m_TextComponent.textInfo.characterInfo[insertionIndex - 1].stringLength;
                        }
                        else if (insertionSide == CaretPosition.Right)
                ...
                if (isDoubleClick)
                {
                    ...
                    if (wordIndex != -1)
                    {
                        ...
                        // Select current word
                        caretPositionpublic = m_TextComponent.textInfo.wordInfo[wordIndex].firstCharacterIndex;
                        caretSelectPositionpublic = m_TextComponent.textInfo.wordInfo[wordIndex].lastCharacterIndex + 1;

                        stringPositionpublic = m_TextComponent.textInfo.characterInfo[caretPositionpublic].index;
                        stringSelectPositionpublic = m_TextComponent.textInfo.characterInfo[caretSelectPositionpublic - 1].index + m_TextComponent.textInfo.characterInfo[caretSelectPositionpublic - 1].stringLength;
                    }
                    else
                    {
                        // Select current character
                        caretPositionpublic = insertionIndex;
                        caretSelectPositionpublic = caretPositionpublic + 1;

                        stringPositionpublic = m_TextComponent.textInfo.characterInfo[insertionIndex].index;
                        stringSelectPositionpublic = stringPositionpublic + m_TextComponent.textInfo.characterInfo[insertionIndex].stringLength;
                    }
                }
                else
                {
                    caretPositionpublic = caretSelectPositionpublic = GetCaretPositionFromStringIndex(stringPositionpublic);
                }
        ...
        private string GetSelectedString()
        {
            ...
            int startPos = stringPositionpublic;
            int endPos = stringSelectPositionpublic;
        ...
        {
            if (stringSelectPositionpublic + 1 >= text.Length)
                return text.Length;

            int spaceLoc = text.IndexOfAny(kSeparators, stringSelectPositionpublic + 1);
        ...
        private void MoveRight(bool shift, bool ctrl)
        {
            if (hasSelection && !shift)
            {
                ...
                stringPositionpublic = stringSelectPositionpublic = Mathf.Max(stringPositionpublic, stringSelectPositionpublic);
                caretPositionpublic = caretSelectPositionpublic = GetCaretPositionFromStringIndex(stringSelectPositionpublic);
            ...
            else
            {
                if (m_isRichTextEditingAllowed)
                {
                    ...
                    if (stringSelectPositionpublic < text.Length && char.IsHighSurrogate(text[stringSelectPositionpublic]))
                        position = stringSelectPositionpublic + 2;
                    else
                        position = stringSelectPositionpublic + 1;
                }
                else
                {
                    position = m_TextComponent.textInfo.characterInfo[caretSelectPositionpublic].index + m_TextComponent.textInfo.characterInfo[caretSelectPositionpublic].stringLength;
                }
            ...
            {
                stringSelectPositionpublic = stringPositionpublic = position;

                // Only increase caret position as we cross character boundary.
                if (stringPositionpublic >= m_TextComponent.textInfo.characterInfo[caretPositionpublic].index + m_TextComponent.textInfo.characterInfo[caretPositionpublic].stringLength)
                    caretSelectPositionpublic = caretPositionpublic = GetCaretPositionFromStringIndex(stringSelectPositionpublic);
            }
        ...
        {
            if (stringSelectPositionpublic - 2 < 0)
                return 0;

            int spaceLoc = text.LastIndexOfAny(kSeparators, stringSelectPositionpublic - 2);
        ...
        private void MoveLeft(bool shift, bool ctrl)
        {
            if (hasSelection && !shift)
            {
                ...
                stringPositionpublic = stringSelectPositionpublic = Mathf.Min(stringPositionpublic, stringSelectPositionpublic);
                caretPositionpublic = caretSelectPositionpublic = GetCaretPositionFromStringIndex(stringSelectPositionpublic);
            ...
            else
            {
                ...
                {
                    // Special handling for Surrogate pairs and Diacritical marks.
                    if (stringSelectPositionpublic > 0 && char.IsLowSurrogate(text[stringSelectPositionpublic - 1]))
                        position = stringSelectPositionpublic - 2;
                    else
                        position =  stringSelectPositionpublic - 1;
                }
                ...
                {
                    position = caretSelectPositionpublic < 1
                        ? m_TextComponent.textInfo.characterInfo[0].index
                        : m_TextComponent.textInfo.characterInfo[caretSelectPositionpublic - 1].index;
                }
            }
            ...
            else
            {
                ...
                if (caretPositionpublic > 0 && stringPositionpublic <= m_TextComponent.textInfo.characterInfo[caretPositionpublic - 1].index)
                    caretSelectPositionpublic = caretPositionpublic = GetCaretPositionFromStringIndex(stringSelectPositionpublic);
            }
        ...
        private void MoveDown(bool shift, bool goToLastChar)
        {
            if (hasSelection && !shift)
            {
                ...
                caretPositionpublic = caretSelectPositionpublic = Mathf.Max(caretPositionpublic, caretSelectPositionpublic);
            }

            int position = multiLine ? LineDownCharacterPosition(caretSelectPositionpublic, goToLastChar) : m_TextComponent.textInfo.characterCount - 1; // text.Length;

            if (shift)
            {
                caretSelectPositionpublic = position;
                stringSelectPositionpublic = GetStringIndexFromCaretPosition(caretSelectPositionpublic);
            }
            else
            {
                caretSelectPositionpublic = caretPositionpublic = position;
                stringSelectPositionpublic = stringPositionpublic = GetStringIndexFromCaretPosition(caretSelectPositionpublic);
            }
        ...
        private void MoveUp(bool shift, bool goToFirstChar)
        {
            if (hasSelection && !shift)
            {
                ...
                caretPositionpublic = caretSelectPositionpublic = Mathf.Min(caretPositionpublic, caretSelectPositionpublic);
            }

            int position = multiLine ? LineUpCharacterPosition(caretSelectPositionpublic, goToFirstChar) : 0;
        ...
        private void MovePageUp(bool shift, bool goToFirstChar)
        {
            ...
            int position = multiLine ? PageUpCharacterPosition(caretSelectPositionpublic, goToFirstChar) : 0;
        ...
        private void MovePageDown(bool shift, bool goToLastChar)
        {
            ...
            int position = multiLine ? PageDownCharacterPosition(caretSelectPositionpublic, goToLastChar) : m_TextComponent.textInfo.characterCount - 1;
        ...
        private void DeleteKey()
        {
            ...
            else
            {
                if (m_isRichTextEditingAllowed)
                {
                    if (stringPositionpublic < text.Length)
                    {
                        // Special handling for Surrogate Pairs
                        if (char.IsHighSurrogate(text[stringPositionpublic]))
                            m_Text = text.Remove(stringPositionpublic, 2);
                        else
                            m_Text = text.Remove(stringPositionpublic, 1);
                ...
                {
                    if (caretPositionpublic < m_TextComponent.textInfo.characterCount - 1)
                    {
                        int numberOfCharactersToRemove = m_TextComponent.textInfo.characterInfo[caretPositionpublic].stringLength;

                        // Adjust string position to skip any potential rich text tags.
                        int nextCharacterStringPosition = m_TextComponent.textInfo.characterInfo[caretPositionpublic].index;
        ...
        private void Backspace()
        {
            ...
            else
            {
                if (m_isRichTextEditingAllowed)
                {
                    if (stringPositionpublic > 0)
                    {
                        int numberOfCharactersToRemove = 1;

                        // Special handling for Surrogate pairs and Diacritical marks
                        if (char.IsLowSurrogate(text[stringPositionpublic - 1]))
                            numberOfCharactersToRemove = 2;

                        stringSelectPositionpublic = stringPositionpublic = stringPositionpublic - numberOfCharactersToRemove;

                        m_Text = text.Remove(stringPositionpublic, numberOfCharactersToRemove);

                        caretSelectPositionpublic = caretPositionpublic = caretPositionpublic - 1;
                ...
                {
                    if (caretPositionpublic > 0)
                    {
                        int numberOfCharactersToRemove = m_TextComponent.textInfo.characterInfo[caretPositionpublic - 1].stringLength;

                        // Delete the previous character
                        m_Text = text.Remove(m_TextComponent.textInfo.characterInfo[caretPositionpublic - 1].index, numberOfCharactersToRemove);

                        // Get new adjusted string position
                        stringSelectPositionpublic = stringPositionpublic = caretPositionpublic < 1
                            ? m_TextComponent.textInfo.characterInfo[0].index
                            : m_TextComponent.textInfo.characterInfo[caretPositionpublic - 1].index;
        ...
        protected virtual void Append(char input)
        {
            ...
            int insertionPosition = Mathf.Min(stringPositionpublic, stringSelectPositionpublic);
        ...
        protected void SendOnTextSelection()
        {
            ...
            if (onTextSelection != null)
                onTextSelection.Invoke(m_Text, stringPositionpublic, stringSelectPositionpublic);
        }
        ...
        protected void SendOnEndTextSelection()
        {
            ...
            if (onEndTextSelection != null)
                onEndTextSelection.Invoke(m_Text, stringPositionpublic, stringSelectPositionpublic);
        ...
        private void OnFillVBO(Mesh vbo)
        {
            using (var helper = new VertexHelper())
            {
                ...
                {
                    stringPositionpublic = GetStringIndexFromCaretPosition(m_CaretPosition);
                    stringSelectPositionpublic = GetStringIndexFromCaretPosition(m_CaretSelectPosition);
        ...
        private void GenerateCaret(VertexHelper vbo, Vector2 roundingOffset)
        {
            ...
            if (caretPositionpublic >= m_TextComponent.textInfo.characterInfo.Length)
                return;

            int currentLine = m_TextComponent.textInfo.characterInfo[caretPositionpublic].lineNumber;

            // Caret is positioned at the origin for the first character of each lines and at the advance for subsequent characters.
            if (caretPositionpublic == m_TextComponent.textInfo.lineInfo[currentLine].firstCharacterIndex)
            {
                currentCharacter = m_TextComponent.textInfo.characterInfo[caretPositionpublic];
            ...
            {
                currentCharacter = m_TextComponent.textInfo.characterInfo[caretPositionpublic - 1];
                height = currentCharacter.ascender - currentCharacter.descender;
        ...
        private void GenerateHightlight(VertexHelper vbo, Vector2 roundingOffset)
        {
            ...
            // Make sure caret position does not exceed characterInfo array size.
            //if (caretSelectPositionpublic >= m_TextComponent.textInfo.characterInfo.Length)
            //    return;

            TMP_TextInfo textInfo = m_TextComponent.textInfo;

            m_CaretPosition = GetCaretPositionFromStringIndex(stringPositionpublic);
            m_CaretSelectPosition = GetCaretPositionFromStringIndex(stringSelectPositionpublic);
            ...
            if (m_SoftKeyboard != null)
            {
                ...
                int length = m_CaretPosition < m_CaretSelectPosition ? stringSelectPositionpublic - stringPosition : stringPositionpublic - stringPosition;
        ...
        protected char Validate(string text, int pos, char ch)
        {
            ...
            if (characterValidation == CharacterValidation.Integer || characterValidation == CharacterValidation.Decimal)
            {
                ...
                bool selectionAtStart = stringPositionpublic == 0 || stringSelectPositionpublic == 0;
                if (!cursorBeforeDash)
                {
            ...
            else if (characterValidation == CharacterValidation.CustomValidator)
            {
                if (m_InputValidator != null)
                {
                    ...
                    m_Text = text;
                    stringSelectPositionpublic = stringPositionpublic = pos;
                    return c;
                }
            }
            return (char)0;
        ...
        private void ActivateInputFieldInternal()
        {
            ...
            if (TouchScreenKeyboard.isSupported && shouldHideSoftKeyboard == false)
            {
                ...
                if (shouldHideSoftKeyboard == false && m_ReadOnly == false)
                {
                    ...
                    // As such, we set the selection to match the Input Field's public selection.
                    if (m_SoftKeyboard != null)
                    {
                        int length = stringPositionpublic < stringSelectPositionpublic ? stringSelectPositionpublic - stringPositionpublic : stringPositionpublic - stringSelectPositionpublic;
                        m_SoftKeyboard.selection = new RangeInt(stringPositionpublic < stringSelectPositionpublic ? stringPositionpublic : stringSelectPositionpublic, length);
