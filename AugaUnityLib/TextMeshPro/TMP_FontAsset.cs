...
namespace TMProX
{
    ...
    public class TMP_FontAsset : TMP_Asset
    {
        ...
        [SerializeField]
        public List<TMP_Character> m_CharacterTable = new List<TMP_Character>();
        ...
        public void InitializeCharacterLookupDictionary()
        {
            ...
            // Clear public fallback references
        ...
        public HashSet<int> FallbackSearchQueryLookup = new HashSet<int>();
        ...
        /// <summary>
        /// public function used to get the glyph index for the given Unicode.
        /// </summary>
        ...
        ///
        /// </summary>
        public List<uint> m_GlyphsToAdd = new List<uint>();
        public HashSet<uint> m_GlyphsToAddLookup = new HashSet<uint>();

        public List<TMP_Character> m_CharactersToAdd = new List<TMP_Character>();
        public HashSet<uint> m_CharactersToAddLookup = new HashSet<uint>();

        /// <summary>
        /// public list used to track characters that could not be added to the font asset.
        /// </summary>
        public List<uint> s_MissingCharacterList = new List<uint>();

        /// <summary>
        /// Hash table used to track characters that are known to be missing from the font file.
        /// </summary>
        public HashSet<uint> m_MissingUnicodesFromFontFile = new HashSet<uint>();

        /// <summary>
        /// public static array used to avoid allocations when using the GetGlyphPairAdjustmentTable().
        /// </summary>
        ...
        */
        ...
        /// Function assumes public user has already checked to make sure the character is not already contained in the font asset.
        /// </summary>
        /// <param name="unicode">The Unicode value of the character.</param>
        /// <param name="character">The character data if successfully added to the font asset. Null otherwise.</param>
        /// <returns>Returns true if the character has been added. False otherwise.</returns>
        ...
        /// <summary>
        /// public method to copy generic list data to generic array of the same type.
        /// </summary>
        ...
        /// Function might be changed to public and only used in tests.
        /// </summary>
        ...
        /// <summary>
        /// public function to clear all atlas textures.
        /// </summary>
        ...
        /// <summary>
        /// public method used to upgrade font asset to support Dynamic SDF.
        /// </summary>
