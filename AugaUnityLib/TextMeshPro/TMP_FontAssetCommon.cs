...
namespace TMProX
{
    ...
    public struct GlyphValueRecord_Legacy
    {
        ...
        public GlyphValueRecord_Legacy(UnityEngine.TextCore.LowLevel.GlyphValueRecord valueRecord)
        {
    ...
    public class KerningPair
    {
        ...
        public static KerningPair empty = new KerningPair(0, new GlyphValueRecord_Legacy(), 0, new GlyphValueRecord_Legacy());
