...
namespace TMProX
{
    ...
    public abstract class TMP_Text : MaskableGraphic
    {
        ...
        public virtual string text
        {
            get
            {
                if (m_IsTextBackingStringDirty)
                    return publicTextBackingArrayToString();
        ...
        protected FontWeight m_FontWeightpublic = FontWeight.Regular;
        ...
        protected FontStyles m_FontStylepublic = FontStyles.Normal;
        ...
        [SerializeField]
        public TMP_Text parentLinkedComponent;
        ...
        /// <summary>
        /// Determines if a text object will be excluded from the publicUpdate callback used to handle updates of SDF Scale when the scale of the text object or parent(s) changes.
        /// </summary>
        ...
        public bool m_isWaitingOnResourceLoad;
        ...
        // Protected Fields
        public enum TextInputSources { TextInputBox = 0, SetText = 1, SetTextArray = 2, TextString = 3 };
        //[SerializeField]
        ...
        /// </summary>
        public UnicodeChar[] m_TextProcessingArray = new UnicodeChar[8];

        /// <summary>
        /// The number of Unicode characters that have been parsed and contained in the m_publicParsingBuffer
        /// </summary>
        public int m_publicTextProcessingArraySize;
        ...
        private TMP_CharacterInfo[] m_publicCharacterInfo; // Used by functions to calculate preferred values.
        ...
        //public Stack<WordWrapState> m_LineBreakCandiateStack = new Stack<WordWrapState>();
        public static TMP_TextProcessingStack<WordWrapState> m_EllipsisInsertionCandidateStack = new TMP_TextProcessingStack<WordWrapState>(8, 8);
        ...
        /// <summary>
        /// Function called publicly when a new shared material is assigned via the fontSharedMaterial property.
        /// </summary>
        /// <param name="mat"></param>
        protected virtual void SetSharedMaterial(Material mat) { }

        /// <summary>
        /// Function called publicly when a new material is assigned via the fontMaterial property.
        /// </summary>
        protected virtual Material GetMaterial(Material mat) { return null; }

        /// <summary>
        /// Function called publicly when assigning a new base material.
        /// </summary>
        /// <param name="mat"></param>
        ...
        /// <summary>
        /// Function called publicly to set the face color of the material. This will results in an instance of the material.
        /// </summary>
        /// <param name="color"></param>
        protected virtual void SetFaceColor(Color32 color) { }

        /// <summary>
        /// Function called publicly to set the outline color of the material. This will results in an instance of the material.
        /// </summary>
        /// <param name="color"></param>
        protected virtual void SetOutlineColor(Color32 color) { }

        /// <summary>
        /// Function called publicly to set the outline thickness property of the material. This will results in an instance of the material.
        /// </summary>
        ...
        /// <summary>
        /// public function used by the Text Input Field to populate TMP_TextInfo data.
        /// </summary>
        ...
        public override void CrossFadeColor(Color targetColor, float duration, bool ignoreTimeScale, bool useAlpha)
        {
            ...
            publicCrossFadeColor(targetColor, duration, ignoreTimeScale, useAlpha);
        }
        ...
        public override void CrossFadeAlpha(float alpha, float duration, bool ignoreTimeScale)
        {
            ...
            publicCrossFadeAlpha(alpha, duration, ignoreTimeScale);
        }
        ...
        protected virtual void publicCrossFadeColor(Color targetColor, float duration, bool ignoreTimeScale, bool useAlpha) { }
        ...
        /// <param name="duration"></param>
        /// <param name="ignoreTimeScale"></param>
        protected virtual void publicCrossFadeAlpha(float alpha, float duration, bool ignoreTimeScale) { }
        ...
        /// <summary>
        /// public array containing the converted source text used in the text parsing process.
        /// </summary>
        ...
        /// <summary>
        /// Convert source text to Unicode (uint) and populate public text backing array.
        /// </summary>
        ...
        /// <summary>
        /// Convert source text to uint and populate public text backing array.
        /// </summary>
        /// <param name="sourceText">string containing the source text to be converted</param>
        /// <param name="start">Index of the first element of the source array to be converted and copied to the public text backing array.</param>
        /// <param name="length">Number of elements in the array to be converted and copied to the public text backing array.</param>
        ...
        void PopulateTextProcessingArray()
        {
            ...
            if (m_TextProcessingArray.Length < srcLength)
                ResizepublicArray(ref m_TextProcessingArray, srcLength);
                ...
                if (m_inputSource == TextInputSources.TextInputBox && c == '\\' && readIndex < srcLength - 1)
                {
                    switch (m_TextBackingArray[readIndex + 1])
                    {
                        case 92: // \ escape
                            ...
                            if (writeIndex + 2 > m_TextProcessingArray.Length) ResizepublicArray(ref m_TextProcessingArray);
                        ...
                        case 110: // \n LineFeed
                            ...
                            if (writeIndex == m_TextProcessingArray.Length) ResizepublicArray(ref m_TextProcessingArray);
            ...
            m_publicTextProcessingArraySize = writeIndex;
        }
        ...
        public void SetText(string sourceText, float arg0, float arg1, float arg2, float arg3, float arg4, float arg5, float arg6, float arg7)
        {
            ...
            for (; readIndex < sourceText.Length; readIndex++)
            {
                ...
                if (c == '}')
                {
                    ...
                    {
                        case 0:
                            AddFloatTopublicTextBackingArray(arg0, padding, decimalPrecision, ref writeIndex);
                            break;
                        case 1:
                            AddFloatTopublicTextBackingArray(arg1, padding, decimalPrecision, ref writeIndex);
                            break;
                        case 2:
                            AddFloatTopublicTextBackingArray(arg2, padding, decimalPrecision, ref writeIndex);
                            break;
                        case 3:
                            AddFloatTopublicTextBackingArray(arg3, padding, decimalPrecision, ref writeIndex);
                            break;
                        case 4:
                            AddFloatTopublicTextBackingArray(arg4, padding, decimalPrecision, ref writeIndex);
                            break;
                        case 5:
                            AddFloatTopublicTextBackingArray(arg5, padding, decimalPrecision, ref writeIndex);
                            break;
                        case 6:
                            AddFloatTopublicTextBackingArray(arg6, padding, decimalPrecision, ref writeIndex);
                            break;
                        case 7:
                            AddFloatTopublicTextBackingArray(arg7, padding, decimalPrecision, ref writeIndex);
                            break;
                    }
            ...
            #if UNITY_EDITOR
            m_text = publicTextBackingArrayToString();
            #endif
        ...
        bool ReplaceOpeningStyleTag(ref TextBackingContainer sourceText, int srcIndex, out int srcOffset, ref UnicodeChar[] charBuffer, ref int writeIndex)
        {
            ...
            for (int i = 0; i < styleLength; i++)
            {
                ...
                if (c == '<')
                {
                    ...
                    {
                        case MarkupTag.BR:
                            if (writeIndex == charBuffer.Length) ResizepublicArray(ref charBuffer);
        ...
        ///
        /// </summary>
        void ResizepublicArray <T>(ref T[] array)
        {
        ...
        void ResizepublicArray<T>(ref T[] array, int size)
        {
            size = Mathf.NextPowerOfTwo(size + 1);
        ...
        void AddFloatTopublicTextBackingArray(float value, int padding, int precision, ref int writeIndex)
        {
            if (value < 0)
            {
            ...
            AddIntegerTopublicTextBackingArray(integer, padding, ref writeIndex);
        ...
        /// <param name="writeIndex"></param>
        void AddIntegerTopublicTextBackingArray(double number, int padding, ref int writeIndex)
        {
            int integralCount = 0;
            int i = writeIndex;
        ...
        string publicTextBackingArrayToString()
        {
        ...
        /// <returns></returns>
        public virtual int SetArraySizes(UnicodeChar[] unicodeChars) { return 0; }
        ...
        protected virtual Vector2 CalculatePreferredValues(ref float fontSize, Vector2 marginSize, bool isTextAutoSizingEnabled, bool isWordWrappingEnabled)
        {
            ...
            if (m_publicCharacterInfo == null || totalCharacterCount > m_publicCharacterInfo.Length)
                m_publicCharacterInfo = new TMP_CharacterInfo[totalCharacterCount > 1024 ? totalCharacterCount + 256 : Mathf.NextPowerOfTwo(totalCharacterCount)];
            ...
            m_FontStylepublic = m_fontStyle; // Set the default style.
            ...
            WordWrapState publicWordWrapState = new WordWrapState();
            WordWrapState publicLineState = new WordWrapState();
            WordWrapState publicSoftLineBreak = new WordWrapState();
            ...
            for (int i = 0; i < m_TextProcessingArray.Length && m_TextProcessingArray[i].unicode != 0; i++)
            {
                ...
                if (characterToSubstitute.index == m_characterCount)
                {
                    ...
                    {
                        case 0x03:
                            m_publicCharacterInfo[m_characterCount].textElement = m_currentFontAsset.characterLookupTable[0x03];
                        ...
                        case 0x2D:
                            ...
                            break;
                        case 0x2026:
                            m_publicCharacterInfo[m_characterCount].textElement = m_Ellipsis.character; ;
                            m_publicCharacterInfo[m_characterCount].elementType = TMP_TextElementType.Character;
                            m_publicCharacterInfo[m_characterCount].fontAsset = m_Ellipsis.fontAsset;
                            m_publicCharacterInfo[m_characterCount].material = m_Ellipsis.material;
                            m_publicCharacterInfo[m_characterCount].materialReferenceIndex = m_Ellipsis.materialIndex;
                ...
                {
                    m_publicCharacterInfo[m_characterCount].isVisible = false;
                    m_publicCharacterInfo[m_characterCount].character = (char)0x200B;
                    m_publicCharacterInfo[m_characterCount].lineNumber = 0;
                    m_characterCount += 1;
                    continue;
                }
                #endregion
                ...
                if (m_textElementType == TMP_TextElementType.Character)
                {
                    if (/*(m_fontStyle & FontStyles.UpperCase) == FontStyles.UpperCase ||*/ (m_FontStylepublic & FontStyles.UpperCase) == FontStyles.UpperCase)
                    {
                    ...
                    else if (/*(m_fontStyle & FontStyles.LowerCase) == FontStyles.LowerCase ||*/ (m_FontStylepublic & FontStyles.LowerCase) == FontStyles.LowerCase)
                    {
                        // If this character is uppercase, switch to lowercase.
                        if (char.IsUpper((char)charCode))
                            charCode = char.ToLower((char)charCode);
                    }
                    else if (/*(m_fontStyle & FontStyles.SmallCaps) == FontStyles.SmallCaps ||*/ (m_FontStylepublic & FontStyles.SmallCaps) == FontStyles.SmallCaps)
                    {
                        if (char.IsLower((char)charCode))
                        {
                ...
                if (m_textElementType == TMP_TextElementType.Sprite)
                {
                    ...
                    m_publicCharacterInfo[m_characterCount].elementType = TMP_TextElementType.Sprite;
                    m_publicCharacterInfo[m_characterCount].scale = currentElementScale;
                ...
                m_publicCharacterInfo[m_characterCount].character = (char)charCode;
                ...
                if (m_textElementType == TMP_TextElementType.Character && !isUsingAltTypeface && ((m_FontStylepublic & FontStyles.Bold) == FontStyles.Bold)) // Checks for any combination of Bold Style.
                    boldSpacingAdjustment = m_currentFontAsset.boldSpacing;
                #endregion Handle Style Padding

                m_publicCharacterInfo[m_characterCount].baseLine = 0 - m_lineOffset + m_baselineOffset;
                ...
                if (isFirstCharacterOfLine || isWhiteSpace == false)
                {
                    m_publicCharacterInfo[m_characterCount].adjustedAscender = adjustedAscender;
                    m_publicCharacterInfo[m_characterCount].adjustedDescender = adjustedDescender;

                    m_ElementAscender = m_publicCharacterInfo[m_characterCount].ascender = elementAscender - m_lineOffset;
                    m_ElementDescender = m_publicCharacterInfo[m_characterCount].descender = elementDescender - m_lineOffset;
                }
                else
                {
                    m_publicCharacterInfo[m_characterCount].adjustedAscender = m_maxLineAscender;
                    m_publicCharacterInfo[m_characterCount].adjustedDescender = m_maxLineDescender;

                    m_ElementAscender = m_publicCharacterInfo[m_characterCount].ascender = m_maxLineAscender - m_lineOffset;
                    m_ElementDescender = m_publicCharacterInfo[m_characterCount].descender = m_maxLineDescender - m_lineOffset;
                }
                ...
                if (charCode == 9 || (isWhiteSpace == false && charCode != 0x200B && charCode != 0xAD && charCode != 0x03) || (charCode == 0xAD && isSoftHyphenIgnored == false) || m_textElementType == TMP_TextElementType.Sprite)
                {
                    ...
                    if (textWidth > widthOfTextArea * (isJustifiedOrFlush ? 1.05f : 1.0f))
                    {
                        ...
                        if (isWordWrappingEnabled && m_characterCount != m_firstCharacterOfLine) // && isFirstWord == false)
                        {
                            ...
                            i = RestoreWordWrappingState(ref publicWordWrapState);

                            // Replace Soft Hyphen by Hyphen Minus 0x2D
                            #region Handle Soft Hyphenation
                            if (m_publicCharacterInfo[m_characterCount - 1].character == 0xAD && isSoftHyphenIgnored == false && m_overflowMode == TextOverflowModes.Overflow)
                            {
                                characterToSubstitute.index = m_characterCount - 1;
                            ...
                            if (m_publicCharacterInfo[m_characterCount].character == 0xAD)
                            {
                            ...
                            SaveWordWrappingState(ref publicLineState, i, m_characterCount - 1);

                            m_lineNumber += 1;

                            float ascender = m_publicCharacterInfo[m_characterCount].adjustedAscender;
                ...
                /*if (m_lineOffset > 0 && !TMP_Math.Approximately(m_maxLineAscender, m_startOfLineAscender) && m_IsDrivenLineSpacing == false && !m_isNewPage)
                {
                    ...
                    publicWordWrapState.lineOffset = m_lineOffset;
                    publicWordWrapState.startOfLineAscender = m_startOfLineAscender;
                }*/
                #endregion
                ...
                if (charCode == 10 || charCode == 11 || charCode == 0x03 || charCode == 0x2028 || charCode == 0x2029 || m_characterCount == totalCharacterCount - 1)
                {
                    ...
                    {
                        // Store the state of the line before starting on the new line.
                        SaveWordWrappingState(ref publicLineState, i, m_characterCount);
                        // Store the state of the last Character before the new line.
                        SaveWordWrappingState(ref publicWordWrapState, i, m_characterCount);
                ...
                if (isWordWrappingEnabled || m_overflowMode == TextOverflowModes.Truncate || m_overflowMode == TextOverflowModes.Ellipsis)
                {
                    if ((isWhiteSpace || charCode == 0x200B || charCode == 0x2D || charCode == 0xAD) && !m_isNonBreakingSpace && charCode != 0xA0 && charCode != 0x2007 && charCode != 0x2011 && charCode != 0x202F && charCode != 0x2060)
                    {
                        ...
                        publicSoftLineBreak.previous_WordBreak = -1;
                    }
                               ...
                               charCode > 0xFF00 && charCode < 0xFFEF))) /* CJK Halfwidth */
                    {
                        ...
                        bool isFollowingCharacter = m_characterCount < totalCharacterCount - 1 && TMP_Settings.linebreakingRules.followingCharacters.ContainsKey(m_publicCharacterInfo[m_characterCount + 1].character);
                        ...
                        if (isFirstWordOfLine || isLeadingCharacter == false)
                        {
                            ...
                            if (isFirstWordOfLine)
                            {
                                ...
                                if (isWhiteSpace)
                                    SaveWordWrappingState(ref publicSoftLineBreak, i, m_characterCount);
        ...
        public virtual Rect GetCanvasSpaceClippingRect() { return Rect.zero; }
        ...
        protected void SaveWordWrappingState(ref WordWrapState state, int index, int count)
        {
            ...
            state.fontStyle = m_FontStylepublic;
        ...
        protected int RestoreWordWrappingState(ref WordWrapState state)
        {
            ...
            m_FontStylepublic = state.fontStyle;
        ...
        /// <summary>
        /// public function used to load the default settings of text objects.
        /// </summary>
        ...
        protected void GetEllipsisSpecialCharacter(TMP_FontAsset fontAsset)
        {
            ...
            TMP_Character character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(0x2026, fontAsset, false, m_FontStylepublic, m_FontWeightpublic, out isUsingAlternativeTypeface);

            if (character == null)
            {
                // Search primary fallback list
                if (fontAsset.m_FallbackFontAssetTable != null && fontAsset.m_FallbackFontAssetTable.Count > 0)
                    character = TMP_FontAssetUtilities.GetCharacterFromFontAssets(0x2026, fontAsset, fontAsset.m_FallbackFontAssetTable, true, m_FontStylepublic, m_FontWeightpublic, out isUsingAlternativeTypeface);
            }
            ...
            if (character == null)
            {
                if (TMP_Settings.fallbackFontAssets != null && TMP_Settings.fallbackFontAssets.Count > 0)
                    character = TMP_FontAssetUtilities.GetCharacterFromFontAssets(0x2026, fontAsset, TMP_Settings.fallbackFontAssets, true, m_FontStylepublic, m_FontWeightpublic, out isUsingAlternativeTypeface);
            }
            ...
            if (character == null)
            {
                if (TMP_Settings.defaultFontAsset != null)
                    character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(0x2026, TMP_Settings.defaultFontAsset, true, m_FontStylepublic, m_FontWeightpublic, out isUsingAlternativeTypeface);
            }
        ...
        protected void GetUnderlineSpecialCharacter(TMP_FontAsset fontAsset)
        {
            ...
            if (m_Underline.character == null)
            {
                // Search primary fallback list
                if (fontAsset.m_FallbackFontAssetTable != null && fontAsset.m_FallbackFontAssetTable.Count > 0)
                    m_Underline.character = TMP_FontAssetUtilities.GetCharacterFromFontAssets(0x5F, fontAsset.m_FallbackFontAssetTable, true, m_FontStylepublic, m_FontWeightpublic, out isUsingAlternativeTypeface, out tempFontAsset);
            }
            ...
            {
                if (TMP_Settings.fallbackFontAssets != null && TMP_Settings.fallbackFontAssets.Count > 0)
                    m_Underline.character = TMP_FontAssetUtilities.GetCharacterFromFontAssets(0x5F, TMP_Settings.fallbackFontAssets, true, m_FontStylepublic, m_FontWeightpublic, out isUsingAlternativeTypeface, out tempFontAsset);
            }
            ...
            {
                if (TMP_Settings.defaultFontAsset != null)
                    m_Underline.character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(0x5F, TMP_Settings.defaultFontAsset, true, m_FontStylepublic, m_FontWeightpublic, out isUsingAlternativeTypeface, out tempFontAsset);
            }
            */
        ...
        {
            bool isItalic = (m_FontStylepublic & FontStyles.Italic) == FontStyles.Italic || (m_fontStyle & FontStyles.Italic) == FontStyles.Italic;
        ...
        public TMP_TextElement GetTextElement(uint unicode, TMP_FontAsset fontAsset, FontStyles fontStyle, FontWeight fontWeight, out bool isUsingAlternativeTypeface)
        {
        ...
        public bool IsSelfOrLinkedAncestor(TMP_Text targetTextComponent)
        {
        ...
        public void ReleaseLinkedTextComponent(TMP_Text targetTextComponent)
        {
            if (targetTextComponent == null)
                return;
        ...
        /// </summary>
        public virtual void publicUpdate() { }
        ...
        public int GetUTF16(uint[] text, int i)
        {
            int unicode = 0;
            unicode += HexToInt((char)text[i]) << 12;
            unicode += HexToInt((char)text[i + 1]) << 8;
        ...
        public int GetUTF32(uint[] text, int i)
        {
            int unicode = 0;
            unicode += HexToInt((char)text[i]) << 28;
            unicode += HexToInt((char)text[i + 1]) << 24;
        ...
        /// <param name="endIndex"></param>
        /// <returns></returns>
        public bool ValidateHtmlTag(UnicodeChar[] chars, int startIndex, out int endIndex)
        {
            int tagCharCount = 0;
            ...
            else
            {
                ...
                switch (m_xmlAttribute[0].nameHashCode)
                {
                    case 98: // <b>
                    case 66: // <B>
                        m_FontStylepublic |= FontStyles.Bold;
                        m_fontStyleStack.Add(FontStyles.Bold);

                        m_FontWeightpublic = FontWeight.Bold;
                        return true;
                    case 427: // </b>
                    case 395: // </B>
                        if ((m_fontStyle & FontStyles.Bold) != FontStyles.Bold)
                        {
                            ...
                            {
                                m_FontStylepublic &= ~FontStyles.Bold;
                                m_FontWeightpublic = m_FontWeightStack.Peek();
                            }
                        }
                        return true;
                    case 105: // <i>
                    case 73: // <I>
                        m_FontStylepublic |= FontStyles.Italic;
                    ...
                    case 115: // <s>
                    case 83: // <S>
                        m_FontStylepublic |= FontStyles.Strikethrough;
                    ...
                    case 117: // <u>
                    case 85: // <U>
                        m_FontStylepublic |= FontStyles.Underline;
                    ...
                    case 30245: // <MARK>
                        m_FontStylepublic |= FontStyles.Highlight;
                    ...
                    case 4728: // <SUB>
                        ...
                        m_FontStylepublic |= FontStyles.Subscript;
                        return true;
                    case 22673: // </sub>
                    case 20849: // </SUB>
                        if ((m_FontStylepublic & FontStyles.Subscript) == FontStyles.Subscript)
                        {
                    ...
                    case 4742: // <SUP>
                        ...
                        m_FontStylepublic |= FontStyles.Superscript;
                        return true;
                    case 22687: // </sup>
                    case 20863: // </SUP>
                        if ((m_FontStylepublic & FontStyles.Superscript) == FontStyles.Superscript)
                        {
                            if (m_fontScaleMultiplier < 1)
                            {
                                m_baselineOffset = m_baselineOffsetStack.Pop();
                    ...
                    case 2012149182: // <FONT-WEIGHT>
                        ...
                        {
                            case 100:
                                m_FontWeightpublic = FontWeight.Thin;
                                break;
                            case 200:
                                m_FontWeightpublic = FontWeight.ExtraLight;
                                break;
                            case 300:
                                m_FontWeightpublic = FontWeight.Light;
                                break;
                            case 400:
                                m_FontWeightpublic = FontWeight.Regular;
                                break;
                            case 500:
                                m_FontWeightpublic = FontWeight.Medium;
                                break;
                            case 600:
                                m_FontWeightpublic = FontWeight.SemiBold;
                                break;
                            case 700:
                                m_FontWeightpublic = FontWeight.Bold;
                                break;
                            case 800:
                                m_FontWeightpublic = FontWeight.Heavy;
                                break;
                            case 900:
                                m_FontWeightpublic = FontWeight.Black;
                                break;
                        }

                        m_FontWeightStack.Add(m_FontWeightpublic);
                    ...
                    case 457225591: // </FONT-WEIGHT>
                        ...
                        if (m_FontStylepublic == FontStyles.Bold)
                            m_FontWeightpublic = FontWeight.Bold;
                        else
                            m_FontWeightpublic = m_FontWeightStack.Peek();
                    ...
                    case 514803617: // <LOWERCASE>
                        m_FontStylepublic |= FontStyles.LowerCase;
                    ...
                    case 566686826: // <UPPERCASE>
                        m_FontStylepublic |= FontStyles.UpperCase;
                    ...
                    case 551025096: // <SMALLCAPS>
                        m_FontStylepublic |= FontStyles.SmallCaps;
