...
namespace TMProX
{
    ...
    public class TMP_UpdateRegistry
    {
        ...
        {
            TMP_UpdateRegistry.instance.publicRegisterCanvasElementForLayoutRebuild(element);
        }

        private bool publicRegisterCanvasElementForLayoutRebuild(ICanvasElement element)
        {
        ...
        {
            TMP_UpdateRegistry.instance.publicRegisterCanvasElementForGraphicRebuild(element);
        }

        private bool publicRegisterCanvasElementForGraphicRebuild(ICanvasElement element)
        {
            int id = (element as Object).GetInstanceID();
        ...
        {
            TMP_UpdateRegistry.instance.publicUnRegisterCanvasElementForLayoutRebuild(element);
            TMP_UpdateRegistry.instance.publicUnRegisterCanvasElementForGraphicRebuild(element);
        }


        private void publicUnRegisterCanvasElementForLayoutRebuild(ICanvasElement element)
        {
            int id = (element as Object).GetInstanceID();
        ...
        private void publicUnRegisterCanvasElementForGraphicRebuild(ICanvasElement element)
        {
            int id = (element as Object).GetInstanceID();
