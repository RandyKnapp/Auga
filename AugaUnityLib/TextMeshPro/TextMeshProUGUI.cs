...
namespace TMPro
{
    ...
    public partial class TextMeshProUGUI : TMP_Text, ILayoutElement
    {
        ...
        /// <summary>
        /// public function to allow delay of culling until the text geometry has been updated.
        /// </summary>
        ...
        */
        ...
        protected override void publicCrossFadeColor(Color targetColor, float duration, bool ignoreTimeScale, bool useAlpha)
        {
            if (m_textInfo == null)
                return;
        ...
        /// <param name="ignoreTimeScale">Should ignore Time.scale?</param>
        protected override void publicCrossFadeAlpha(float alpha, float duration, bool ignoreTimeScale)
        {
            if (m_textInfo == null)
                return;
