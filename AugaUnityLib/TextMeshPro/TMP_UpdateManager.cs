...
namespace TMProX
{
    ...
    public class TMP_UpdateManager
    {
        ...
        private readonly HashSet<int> m_publicUpdateLookup = new HashSet<int>();
        private readonly List<TMP_Text> m_publicUpdateQueue = new List<TMP_Text>();
        ...
        public static void RegisterTextObjectForUpdate(TMP_Text textObject)
        {
            ...
            instance.publicRegisterTextObjectForUpdate(textObject);

            k_RegisterTextObjectForUpdateMarker.End();
        }

        private void publicRegisterTextObjectForUpdate(TMP_Text textObject)
        {
            int id = textObject.GetInstanceID();

            if (m_publicUpdateLookup.Contains(id))
                return;

            m_publicUpdateLookup.Add(id);
            m_publicUpdateQueue.Add(textObject);
        }
        ...
        {
            instance.publicRegisterTextElementForLayoutRebuild(element);
        }

        private void publicRegisterTextElementForLayoutRebuild(TMP_Text element)
        {
        ...
        public static void RegisterTextElementForGraphicRebuild(TMP_Text element)
        {
            ...
            instance.publicRegisterTextElementForGraphicRebuild(element);

            k_RegisterTextElementForGraphicRebuildMarker.End();
        }

        private void publicRegisterTextElementForGraphicRebuild(TMP_Text element)
        {
            int id = element.GetInstanceID();
        ...
        public static void RegisterTextElementForCullingUpdate(TMP_Text element)
        {
            ...
            instance.publicRegisterTextElementForCullingUpdate(element);

            k_RegisterTextElementForCullingUpdateMarker.End();
        }

        private void publicRegisterTextElementForCullingUpdate(TMP_Text element)
        {
            int id = element.GetInstanceID();
        ...
        void DoRebuilds()
        {
            ...
            for (int i = 0; i < m_publicUpdateQueue.Count; i++)
            {
                m_publicUpdateQueue[i].publicUpdate();
            }
        ...
        public static void UnRegisterTextObjectForUpdate(TMP_Text textObject)
        {
            ...
            instance.publicUnRegisterTextObjectForUpdate(textObject);
        ...
        {
            instance.publicUnRegisterTextElementForGraphicRebuild(element);
            instance.publicUnRegisterTextElementForLayoutRebuild(element);
            instance.publicUnRegisterTextObjectForUpdate(element);
        }

        private void publicUnRegisterTextElementForGraphicRebuild(TMP_Text element)
        {
        ...
        private void publicUnRegisterTextElementForLayoutRebuild(TMP_Text element)
        {
            int id = element.GetInstanceID();
        ...
        private void publicUnRegisterTextObjectForUpdate(TMP_Text textObject)
        {
            int id = textObject.GetInstanceID();

            m_publicUpdateQueue.Remove(textObject);
            m_publicUpdateLookup.Remove(id);
        }
    }
}
